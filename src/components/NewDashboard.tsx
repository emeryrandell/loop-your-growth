...
const NewDashboard = () => {
  ...
  if (showOnboarding) {
    return (
      <div className="min-h-screen bg-background">
        <TrainerOnboarding
          onComplete={(data) => completeOnboarding.mutate(data)}
        />
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-background">
      <div
        className={`max-w-7xl mx-auto px-4 py-8 transition-all duration-300 ${
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {todayChallenge ? (
              <Card className="card-feature relative border-2 border-primary/20 shadow-glow">
                <div
                  className={`absolute top-0 left-0 w-2 h-full ${getCategoryColor(
                    ...
                    <div className="bg-gradient-to-r from-success/10 to-primary/10 rounded-lg p-4 mb-6 border border-success/20">
                      <div className="flex items-start space-x-3">
                        ...
                        <p className="text-sm font-medium">
                          <span className="text-success">Why this works:</span>{" "}
                          {todayChallenge.benefit}
                        </p>
                      </div>
                    </div>
                  ...
                  {todayChallenge.status === "completed" ? (
                    <div className="text-center py-8 space-y-4">
                      ...
                      <p className="text-muted-foreground">
                        Excellent work! Your coach is preparing tomorrow's
                        challenge.
                      </p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-3 gap-2 mt-4">
                        ...
                        <Button
                          variant={
                            feedback === "just_right" ? "default" : "ghost"
                          }
                          size="sm"
              ...
              <Card className="card-feature border-2 border-dashed border-muted-foreground/30">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Create your first custom challenge to get started on your 1%
                    improvement journey.
                  </p>
        ...
        challenge={
          todayChallenge
            ? {
                ...todayChallenge,
                difficulty:
                  typeof todayChallenge.difficulty === "string"
